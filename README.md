About apache-airflow-providers-imap-feedstock
=============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-imap-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-imap-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-imap
# for installing globally
pixi global install apache-airflow-providers-imap
```
...
It is possible to list all of the versions of `apache-airflow-providers-imap` available on your platform:
...
```
pixi search apache-airflow-providers-imap --channel conda-forge
```
